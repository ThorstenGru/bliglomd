      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form onSubmit={saveName} className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            disabled={nameSaving}
            className={`w-full sm:w-auto px-4 py-3 sm:py-2.5 rounded-xl text-sm font-medium transition-colors disabled:opacity-50 ${
        ...
        {emailDone ? (
          ...
          <form onSubmit={changeEmail} className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-4 py-3 sm:py-2.5 rounded-xl text-sm font-medium bg-brand-600 text-white hover:bg-brand-700 transition-colors disabled:opacity-50"
            >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          {hasActiveSubscription && (
            <button
              ...
              className="inline-block py-3 sm:py-0 text-left text-sm text-gray-600 hover:text-gray-900 underline underline-offset-2 transition-colors disabled:opacity-50"
            >
      ...
      <div className="bg-white rounded-2xl border border-red-200 p-6">
        ...
        {!showDeleteConfirm ? (
          <button
            ...
            className="w-full sm:w-auto px-4 py-3 sm:py-2.5 rounded-xl text-sm font-medium border border-red-300 text-red-700 hover:bg-red-50 transition-colors"
          >
            {t.profile.deleteBtn}
          </button>
        ) : (
          <div className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="w-full sm:w-auto px-4 py-3 sm:py-2.5 rounded-xl text-sm font-medium bg-red-600 text-white hover:bg-red-700 transition-colors disabled:opacity-50"
              >
                {deleting ? t.auth.waiting : t.profile.deleteConfirmBtn}
              </button>
              <button
                onClick={() => { setShowDeleteConfirm(false); setDeleteWord(''); setDeleteError(null) }}
                className="w-full sm:w-auto px-4 py-3 sm:py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-800 transition-colors"
              >
