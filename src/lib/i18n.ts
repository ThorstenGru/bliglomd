...
export const translations = {
  sv: {
    ...
    home: {
      ...
      footer: '© 2026 BliGlömd. Alla rättigheter förbehållna.',
      ...
      footerCopyright: 'Data lagras i Sverige · © 2026 BliGlömd · Lykkebo Fastigheter Kommanditbolag, Org.nr 969797-1647',
    ...
    auth: {
      ...
      signupDoneSpam: 'Ser du inget mejl inom någon minut? Kolla din skräppost/spam-mapp — bekräftelsemejl hamnar där ibland, särskilt för nya avsändaradresser.',
    ...
    scan: {
      ...
      breachCheckUnavailable: 'Dataintrångskontrollen kunde inte köras just nu — det säger inget om huruvida ditt e-postkonto är drabbat eller inte. Försök igen om en stund, eller fortsätt nedan — resten av sökningen fungerar som vanligt.',
    ...
    request: {
      ...
      gateLoginBtn: 'Logga in',
      gateUpgradeTitle: 'Den här nivån ingår i',
      gateUpgradeBtn: 'Uppgradera till',
      sendTo: 'Skicka till',
  ...
  en: {
    ...
    home: {
      ...
      footer: '© 2026 BliGlömd. All rights reserved.',
      ...
      footerCopyright: 'Data stored in Sweden · © 2026 BliGlömd · Lykkebo Fastigheter Kommanditbolag, Reg. no. 969797-1647',
    ...
    auth: {
      ...
      signupDoneSpam: 'Don\'t see the email within a minute or two? Check your spam/junk folder — confirmation emails sometimes land there, especially from newer sending addresses.',
    ...
    scan: {
      ...
      breachCheckUnavailable: "The breach check couldn't run right now — this says nothing about whether your email is affected or not. Try again shortly, or continue below — the rest of the search works as usual.",
    ...
    request: {
      ...
      gateLoginTitle: 'Log in to unlock this level.',
      gateLoginBtn: 'Log in',
      gateUpgradeTitle: 'This level is included in',
      gateUpgradeBtn: 'Upgrade to',
      sendTo: 'Send to',
